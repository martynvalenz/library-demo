            ...
            <q-form>
              <q-card-section>
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-xs-12 q-px-sm text-subtitle1">
                    <router-link to="/auth/recover" class="linker"
                ...
                <div class="row q-pt-md text-center">
                  <div class="col-xs-12 q-pa-sm text-subtitle1">
                    ...
                    <router-link to="/auth/register" class="linker"
                      >Sign Up</router-link
                    >
                  </div>
                </div>
...
export default defineComponent({
  setup() {
    ...
    const title = ref(`Login | ${process.env.TITLE}`);
    useMeta(() => {
      return {
    ...
    const signIn = () => {
      loading.value = true;
      axios.post(`${process.env.API}/auth/login`, {
        email: email.value,
